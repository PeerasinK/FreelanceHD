<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SrchMgmt.aspx.cs" Inherits="HondaTraceabilitySystem.Common.Search.SrchMgmt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Management Level</title>
					...
					<div class="w-100">
						<asp:GridView ID="dgvSearch" runat="server"  BackColor="White"
							...
							<Columns>
                                ...
                                <ItemTemplate>
                                    <asp:textbox ID="lblMgmtLvl" runat="server" CssClass="form-control" Text='<%# Bind("MANAGEMENT_LEVEL") %>' ToolTip='<%# Bind("MANAGEMENT_LEVEL") %>' ReadOnly="true" BorderStyle="None" BackColor="Transparent" BorderWidth="0px"></asp:textbox>                  
                                </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Management Desc" >
                                    <ItemTemplate>
                                        <asp:textbox ID="lblMgmtDesc" runat="server" CssClass="form-control" Text='<%# Bind("MANAGEMENT_DESCRIPTION") %>' ToolTip='<%# Bind("MANAGEMENT_DESCRIPTION") %>' ReadOnly="true" BorderStyle="None" BackColor="Transparent" BorderWidth="0px"></asp:textbox>
                                    </ItemTemplate>
