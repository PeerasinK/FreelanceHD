<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SrchLocation.aspx.cs" Inherits="HondaTraceabilitySystem.Common.Search.SrchLocation" %>
					...
					<div class="w-100">
						<asp:GridView ID="dgvSearch" runat="server"  BackColor="White"
							...
							<Columns>
                                ...
                                <ItemTemplate>
                                    <asp:textbox ID="lblLocCd" runat="server" CssClass="form-control" Text='<%# Bind("LOCATION_NO") %>' ToolTip='<%# Bind("LOCATION_NO") %>' ReadOnly="true" BorderStyle="None" BackColor="Transparent" BorderWidth="0px"></asp:textbox>                  
                                </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Location Name" >
                                    <ItemTemplate>
                                        <asp:textbox ID="lblLocDesc" runat="server" CssClass="form-control" Text='<%# Bind("LOCATION_NAME") %>' ToolTip='<%# Bind("LOCATION_NAME") %>' ReadOnly="true" BorderStyle="None" BackColor="Transparent" BorderWidth="0px"></asp:textbox>
                                    </ItemTemplate>
