<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SrchProcess.aspx.cs" Inherits="HondaTraceabilitySystem.Common.Search.SrchProcess" %>
					...
					<div class="w-100">
						<asp:GridView ID="dgvSearch" runat="server"  BackColor="White"
							...
							<Columns>
                                ...
                                <ItemTemplate>
                                    <asp:textbox ID="lblProcessCd" runat="server" CssClass="form-control" Text='<%# Bind("PROCESS_NO") %>' ToolTip='<%# Bind("PROCESS_NO") %>' ReadOnly="true" BorderStyle="None" BackColor="Transparent" BorderWidth="0px"></asp:textbox>                  
                                </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Process Name" >
                                    <ItemTemplate>
                                        <asp:textbox ID="lblProcessDesc" runat="server" CssClass="form-control" Text='<%# Bind("PROCESS_NAME") %>' ToolTip='<%# Bind("PROCESS_NAME") %>' ReadOnly="true" BorderStyle="None" BackColor="Transparent" BorderWidth="0px"></asp:textbox>
                                    </ItemTemplate>
