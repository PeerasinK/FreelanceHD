<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SrchUser.aspx.cs" Inherits="HondaTraceabilitySystem.Common.Search.SrchUser" %>
					...
					<div class="w-100">
						<asp:GridView ID="dgvSearch" runat="server"  BackColor="White"
							...
							<Columns>
                                ...
                                <ItemTemplate>
                                    <asp:textbox ID="lblUserID" runat="server" CssClass="form-control" Text='<%# Bind("USER_ID") %>' ToolTip='<%# Bind("USER_ID") %>' ReadOnly="true" BorderStyle="None" BackColor="Transparent" BorderWidth="0px"></asp:textbox>                  
                                </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="User Name" >
                                    <ItemTemplate>
                                        <asp:textbox ID="lblUserName" runat="server" CssClass="form-control" Text='<%# Bind("NAME") %>' ToolTip='<%# Bind("NAME") %>' ReadOnly="true" BorderStyle="None" BackColor="Transparent" BorderWidth="0px"></asp:textbox>
                                    </ItemTemplate>
