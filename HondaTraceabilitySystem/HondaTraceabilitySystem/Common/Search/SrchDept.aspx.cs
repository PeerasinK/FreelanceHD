...
{
    public partial class SrchDept : System.Web.UI.Page
    {
        ...
        protected void Script_Proc()
        {
            ...
            sb.Append(@"    $('#hdnDeptNo').val(item1);   ");
            sb.Append(@"    $('#hdnDeptNoDesc').val(item2);   ");
            sb.Append(@"    $('#basicModalDept').modal('hide');   ");
            //sb.Append(@"    $('#basicModalDept2').modal('hide');   ");
            sb.Append(@"} ");
