<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeHTIssue.aspx.cs" Inherits="HondaTraceabilitySystem.FeHTIssue" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>FE Issue - Honda Traceability System</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="230px">FE - Issue</asp:Label>
        </div>
        <div>
        ...
        <div style="WIDTH: 230px; POSITION: relative; HEIGHT: 470px; left: 0px; top: 0px;">
            <asp:panel id="pnlKey" style="Z-INDEX: 103; LEFT: 5px; POSITION: absolute; TOP: 5px; width: 225px; height: 0px;" 
                ...
                <asp:Label ID="flblON_NO" runat="server" >Online No</asp:Label><br />
                    <asp:DropDownList ID="ddlON" runat="server" style="width: 150px;" OnSelectedIndexChanged="ddlON_SelectedIndexChanged" AutoPostBack="True" >
                    </asp:DropDownList>
            ...
            <asp:panel id="pnlDetail" style="Z-INDEX: 102; LEFT: 8px; POSITION: absolute; TOP: 70px; width: 225px; height: 300px;" 
                ...
                <asp:Label ID="flblRCV_QTY" runat="server" >Qty</asp:Label><br/>
