<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AeOffProdRpt.aspx.cs" Inherits="HondaTraceabilitySystem.AeOffProdRpt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AE Offline Summary Report - Honda Traceability System</title>
            ...
            <tr>
                <td style="width: 200px; height: 45px;" valign="top" colspan="2">
                    <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="330px">Off Line Summary Report</asp:Label>
                </td>
            </tr>
            </table>
        </div>
