<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeOnProd2.aspx.cs" Inherits="HondaTraceabilitySystem.FeOnProd2" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Middle Lot Production - Honda Traceability System</title>
            ...
            <tr>
                <td style="width: 200px; height: 45px;" valign="top" colspan="2">
                    <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="330px">Middle Lot Production</asp:Label>
                </td>
            </tr>
            </table>
        </div>
        ...
        <div style="WIDTH: 1073px; POSITION: relative; HEIGHT: 470px; left: 0px; top: 0px;" >
            <asp:panel id="pnlKey" 
                ...
                <asp:DropDownList ID="ddlPROCESS" runat="server" CssClass="form-control" Height="30px" Width="150px" 
                        style=" LEFT: 100px; POSITION: absolute; TOP: 10px" >
                    </asp:DropDownList>
            ...
            <asp:panel id="pnlDetail" 
                ...
                <asp:GridView ID="gdvDetail" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="LaserMark No">                                
                            <ItemTemplate>
                                <asp:TextBox ID="lblONLINE_NO" runat="server" CssClass="form-control" 
                                    Text='<%# Bind("Online_No") %>' ToolTip='<%# Bind("Online_No") %>' 
                        ...
                        <asp:TemplateField HeaderText="Lot No">                                
                            <ItemTemplate>
                                <asp:TextBox ID="lblLOT_NO" runat="server" CssClass="form-control" 
                                    Text='<%# Bind("LotNo_Zozai") %>' ToolTip='<%# Bind("Lotno_Zozai") %>' 
                                    ReadOnly="True" TabIndex="-1"></asp:TextBox>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Rack No">                                
                            <ItemTemplate>
                                <asp:TextBox ID="lblRack_No" runat="server" CssClass="form-control" 
                                    Text='<%# Bind("Rack_No") %>' ToolTip='<%# Bind("Rack_No") %>'></asp:TextBox>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Shift">                                
                            <ItemTemplate>
                                <asp:TextBox ID="lblShift" runat="server" CssClass="form-control" 
                                    Text='<%# Bind("Shift") %>' ToolTip='<%# Bind("Shift") %>'></asp:TextBox>
                            </ItemTemplate>
