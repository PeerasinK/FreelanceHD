<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AeHTCrankShaftSP.aspx.cs" Inherits="HondaTraceabilitySystem.AeHTCrankShaftSP" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AE Crank Shft Swap Process - Honda Traceability System</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="230px">Crank Shaft Swap Procrss</asp:Label>
        </div>
        <div>
