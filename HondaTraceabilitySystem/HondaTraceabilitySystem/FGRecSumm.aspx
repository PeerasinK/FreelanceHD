<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FGRecSumm.aspx.cs" Inherits="HondaTraceabilitySystem.FGRecSumm" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>FG Receiving Summary - Honda Traceability System</title>
            ...
            <tr>
                <td style="width: 200px; height: 45px;" valign="top" colspan="2">
                    <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="330px">FG Receiving Summary</asp:Label>
                </td>
            </tr>
            </table>
        </div>
                ...
                <asp:GridView ID="gdvDetail" runat="server"
                    ...
                    <Columns>
                                <asp:TemplateField HeaderText="No">
                                    <ItemTemplate>
                                        <asp:TextBox ID="lblNo" runat="server"  Text='<%# Bind("No") %>' CssClass="form-control"
                                            ToolTip='<%# Bind("No") %>' ReadOnly="true" BorderStyle="None" BackColor="Transparent" BorderWidth="0px"></asp:TextBox>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Total">
                                    <ItemTemplate>
                                        <asp:TextBox ID="lblTotal" runat="server"  Text='<%# Bind("Total") %>' CssClass="form-control"
                                            ToolTip='<%# Bind("Total") %>' ReadOnly="true" BorderStyle="None" BackColor="Transparent" BorderWidth="0px"></asp:TextBox>
                                    </ItemTemplate>
