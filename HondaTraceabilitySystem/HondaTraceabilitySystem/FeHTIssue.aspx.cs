...
{
    public partial class FeHTIssue : System.Web.UI.Page
    {
        ...
        protected void ddl_edit()
        {
            ...
            dt = tf.GetUnplannedDisbActList2();
            ...
            ddlON.DataValueField = "PROCESS_NO";
            ddlON.DataTextField = "PROCESS_NAME";
            ddlON.DataSource = dt2;
            ddlON.DataBind();
            ...
            if (dt2.Rows.Count > 0)
            {
                ...
                txtLOT_NO.Text = dt2.Rows[0]["LOTNO_ZOZAI"].ToString();
        ...
        protected void btnPrev_Click(object sender, EventArgs e)
        {
            if (hdnNo.Value != "1")
            {
                ...
                lblNo.Text = hdnNo.Value + " of " + hdnMaxNo.Value;
                txtLOT_NO.Text = dt.Rows[i]["LOTNO_ZOZAI"].ToString();
