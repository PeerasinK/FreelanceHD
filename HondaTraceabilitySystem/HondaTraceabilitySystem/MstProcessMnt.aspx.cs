...
{
    public partial class MstProcessMnt : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Init_Label();
                Init_Proc();
                txtProcess.Text = Request.QueryString["ROLE"];
        ...
        protected void Init_Label()
        {
            ...
            //dic.screen_id = "MstProcessMnt_frmMain";
            ...
            //            case "flblProcess": flblProcess.Text = row["ITEM_DESC"].ToString(); break;
            //            case "flblProcessName": flblProcessName.Text = row["ITEM_DESC"].ToString(); break;
            //            case "flblProcessDesc": flblProcessDesc.Text = row["ITEM_DESC"].ToString(); break;
        ...
        protected void Clear_Screen(int flag)
        {
            ...
            txtProcessName.Text = "";
            txtProcessDesc.Text = "";
            //txtManagementDesc3.Text = "";
            //txtManagementDesc4.Text = "";
        }
        ...
        protected void Edit_Screen()
        {
            ...
            txtProcess.Text = process.process_cd;
            ...
            if (txtProcess.Text == "")
            {
                ...
                lblMsg.Text = msg.GetMessage("INPUT_MANDATORY_ERR") + "(" + flblProcess.Text + ")";
                lblMsg.ForeColor = Color.Red;
                return;
            }

            int rtn = process.GetProcessDetail();
            ...
            else
            {
                ...
                else
                {
                    ...
                    txtProcessName.Text = process.process_desc;
                    txtProcessDesc.Text = process.process_desc2;
        ...
        protected void Edit_Grid()
        {
            ...
            Process SrchProcess = new Process(g_user_id, g_lang);
            SrchProcess.process_cd = txtProcess.Text.ToUpper().Trim();
            DataSet ds = SrchProcess.GetProcessList();
        ...
        protected void cmdUserRole_Click(object sender, EventArgs e)
        {
            ...
            if (txtProcess.Text.Trim() != "")
            {
                strRole = txtProcess.Text.Trim().ToUpper();
