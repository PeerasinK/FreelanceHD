<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeOnProd.aspx.cs" Inherits="HondaTraceabilitySystem.FeOnProd" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Online Production - Honda Traceability System</title>
    ...
    <form id="form1" runat="server">
                    ...
                    <table width="100%" border="0">
                        <tr>
                            ...
                            <td style="padding-left: 5px" width="90" valign="bottom">
                                <asp:Button ID="cmdIssue"  runat="server" CssClass="btn btn-success" Text="ISSUE" OnClick="cmdIssue_Click"></asp:Button>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td style="width: 200px; height: 45px;" valign="top" colspan="2">
                    <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="330px">Online Production</asp:Label>
                </td>
            </tr>
            </table>
        </div>
        ...
        <div style="WIDTH: 1073px; POSITION: relative; HEIGHT: 470px; left: 0px; top: 0px;" >
            ...
            <asp:panel id="pnlDetail" 
                    style="Z-INDEX: 102; LEFT: 45px; POSITION: absolute; TOP: 75px; height: 300px; width: 1000px;" 
                    runat="server">

                <asp:CheckBox ID="chkALL_SEL" runat="server" style="LEFT: 2px; POSITION: absolute; TOP: 6px; width:127px;" 
                        Text="All Selected" AutoPostBack="True" oncheckedchanged="chkALL_SEL_CheckedChanged" 
                        />
                ...
                <asp:GridView ID="gdvDetail" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Receive No">                                
                            <ItemTemplate>
                                <asp:TextBox ID="lblRECEIVE_NO" runat="server" CssClass="form-control" 
                                    Text='<%# Bind("Receive_No") %>' ToolTip='<%# Bind("Receive_No") %>' 
                        ...
                        <asp:TemplateField HeaderText="Lot No">                                
                            <ItemTemplate>
                                <asp:TextBox ID="lblLOT_NO" runat="server" CssClass="form-control" 
                                    Text='<%# Bind("Lot_No") %>' ToolTip='<%# Bind("Lot_No") %>' 
                                    ReadOnly="True" TabIndex="-1"></asp:TextBox>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Receive Qty">                                
                            <ItemTemplate>
                                <asp:TextBox ID="lblReceive_Qty" runat="server" CssClass="form-control" 
                                    Text='<%# Bind("Receive_Qty") %>' ToolTip='<%# Bind("Receive_Qty") %>' 
                                    ReadOnly="True" TabIndex="-1"></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle width="100px"/>
                            <HeaderStyle width="100px"/>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Die No">                                
                            <ItemTemplate>
                                <asp:TextBox ID="lblDie_No" runat="server" CssClass="form-control" 
                                    Text='<%# Bind("Die_No") %>' ToolTip='<%# Bind("Die_No") %>' 
                                    ReadOnly="True" TabIndex="-1"></asp:TextBox>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Shift">                                
                            <ItemTemplate>
                                <asp:TextBox ID="lblShift" runat="server" CssClass="form-control" 
                                    Text='<%# Bind("Shift") %>' ToolTip='<%# Bind("Shift") %>' 
                                    ReadOnly="True" TabIndex="-1"></asp:TextBox>
                            </ItemTemplate>
