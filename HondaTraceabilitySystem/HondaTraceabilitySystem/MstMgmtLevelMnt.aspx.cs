...
{
    public partial class MstMgmtLevelMnt : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Init_Label();
                Init_Proc();
                txtManagement.Text = Request.QueryString["ROLE"];
        ...
        protected void Init_Label()
        {
            ...
            flblTitle.Text = "Management Level Master";
            //            case "flblManagement": flblManagement.Text = row["ITEM_DESC"].ToString(); break;
            //            case "flblManagementDesc1": flblManagementDesc1.Text = row["ITEM_DESC"].ToString(); break;
            //                //case "flblManagementDesc2": flblManagementDesc2.Text = row["ITEM_DESC"].ToString(); break;
        ...
        protected void Screen_Control(string pUpdMode)
        {
            ...
            switch (hdnInputMode.Value)
            {
                case "0":
                    ...
                    com.SetInitialFocus(txtManagement);
                    break;
                case "1":
        ...
        protected void Clear_Screen(int flag)
        {
            ...
            txtManagementDesc1.Text = "";
            //txtManagementDesc2.Text = "";
        ...
        protected void cmdUserRole_Click(object sender, EventArgs e)
        {
            ...
            if (txtManagement.Text.Trim() != "")
            {
                strRole = txtManagement.Text.Trim().ToUpper();
