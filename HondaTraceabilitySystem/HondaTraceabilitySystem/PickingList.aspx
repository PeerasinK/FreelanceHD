<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PickingList.aspx.cs" Inherits="HondaTraceabilitySystem.PickingList" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Picking List Print - Honda Traceability System</title>
    ...
    <form id="form1" runat="server">
            ...
            <tr>
                <td style="width: 200px; height: 45px;" valign="top" colspan="2">
                    <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="330px">Picking List Print</asp:Label>
                </td>
            </tr>
            </table>
        </div>
        ...
        <div style="WIDTH: 1073px; POSITION: relative; HEIGHT: 470px; left: 0px; top: 0px;" >
            <asp:panel id="pnlKey" 
                ...
                <asp:Label ID="flblFILE" runat="server" 
                        style=" LEFT: 8px; POSITION: absolute; TOP: 65px" 
                        Width="80px">Order No:</asp:Label>
                <asp:DropDownList ID="ddlFILE" runat="server" CssClass="form-control" Height="40px" Width="300px" 
                        style=" LEFT: 99px; POSITION: absolute; TOP: 60px" AutoPostBack="True" OnSelectedIndexChanged="ddlFILE_SelectedIndexChanged" >
                    </asp:DropDownList>

            </asp:panel>

            <asp:panel id="pnlDetail" 
                    style="Z-INDEX: 102; LEFT: 7px; POSITION: absolute; TOP: 160px; height: 50px; width: 1000px;" 
                    runat="server">
