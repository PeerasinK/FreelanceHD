<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FePartCtrlTag.aspx.cs" Inherits="HondaTraceabilitySystem.FePartCtrlTag" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Part Control Tag - Honda Traceability System</title>
            ...
            <tr>
                <td style="width: 200px; height: 45px;" valign="top" colspan="2">
                    <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="330px">Part Control Tag</asp:Label>
                </td>
            </tr>
            </table>
        </div>
