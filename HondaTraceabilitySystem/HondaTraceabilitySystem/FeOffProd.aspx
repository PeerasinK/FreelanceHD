<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeOffProd.aspx.cs" Inherits="HondaTraceabilitySystem.FeOffProd" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Offline Production - Honda Traceability System</title>
            ...
            <tr>
                <td style="width: 200px; height: 45px;" valign="top" colspan="2">
                    <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="330px">Offline Production</asp:Label>
                </td>
            </tr>
            </table>
        </div>
                ...
                <asp:GridView ID="gdvDetail" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Lot No">                                
                            <ItemTemplate>
                                <asp:TextBox ID="lblLOT_NO" runat="server" CssClass="form-control" 
                                    Text='<%# Bind("LotNo") %>' ToolTip='<%# Bind("Lotno") %>' 
                                    ReadOnly="True" TabIndex="-1"></asp:TextBox>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Model">                                
                            <ItemTemplate>
                                <asp:TextBox ID="lblModel" runat="server" CssClass="form-control" 
                        ...
                        <asp:TemplateField HeaderText="Rack / Box">                                
                            <ItemTemplate>
