...
{
    public partial class MstDeptMnt : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Init_Label();
                Init_Proc();
                txtDepartment.Text = Request.QueryString["ROLE"];
        ...
        protected void Init_Label()
        {
            ...
            //dic.screen_id = "MstDepartment_frmMain";
            ...
            flblTitle.Text = "Department Master";
            //            case "flblDepartment": flblDepartment.Text = row["ITEM_DESC"].ToString(); break;
            //            case "flblDeptName": flblDeptName.Text = row["ITEM_DESC"].ToString(); break;
            //            case "flblDeptDesc": flblDeptDesc.Text = row["ITEM_DESC"].ToString(); break;
        ...
        protected void Screen_Control(string pUpdMode)
        {
            ...
            switch (hdnInputMode.Value)
            {
                case "0":
                    ...
                    com.SetInitialFocus(txtDepartment);
                    break;
                case "1":
        ...
        protected void Edit_Grid()
        {
            ...
            Dept SrchDept = new Dept(g_user_id, g_lang);
            SrchDept.dept_cd = txtDepartment.Text.ToUpper();
            DataSet ds = SrchDept.GetDEPTList();
        ...
        protected void cmdUserRole_Click(object sender, EventArgs e)
        {
            ...
            if (txtDepartment.Text.Trim() != "")
            {
                strRole = txtDepartment.Text.Trim().ToUpper();
