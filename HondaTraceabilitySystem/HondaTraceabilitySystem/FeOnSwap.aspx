<%@ Page Title="Middle Lot Swap" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FeOnSwap.aspx.cs" Inherits="HondaTraceabilitySystem.FeOnSwap" %>
        ...
        <div style="WIDTH: 1073px; POSITION: relative; HEIGHT: 470px; left: 0px; top: 0px;">
            ...
            <asp:panel id="pnlDetail" 
                ...
                <%--<div class="form-group">
                    <asp:Label ID="flblMID_NO" runat="server" >Middle No</asp:Label>
                        <div class="form-inline">
                            <asp:TextBox ID="txtMID_NO" runat="server" CssClass="form-control" ></asp:TextBox>
...
$('#basicModalOffline').on('shown.bs.modal', function (e) {
     ...
     $('#basicModal').on('hidden.bs.modal', function () {
                ...
                document.getElementById('<%=txtMID_NO.ClientID%>').value = value1;
     });
