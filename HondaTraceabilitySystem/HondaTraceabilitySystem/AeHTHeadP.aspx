<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AeHTHeadP.aspx.cs" Inherits="HondaTraceabilitySystem.AeHTHeadP" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AE Head Process - Honda Traceability System</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="230px">Scan Head Process</asp:Label>
        </div>
        <div>
