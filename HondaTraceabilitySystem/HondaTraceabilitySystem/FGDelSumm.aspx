<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FGDelSumm.aspx.cs" Inherits="HondaTraceabilitySystem.FGDelSumm" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>FG Delivery Summary - Honda Traceability System</title>
            ...
            <tr>
                <td style="width: 200px; height: 45px;" valign="top" colspan="2">
                    <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="330px">FG Delivery Summary</asp:Label>
                </td>
            </tr>
            </table>
        </div>
                ...
                <asp:GridView ID="gdvDetail" runat="server"
                    ...
                    <Columns>
                                ...
                                <asp:TemplateField HeaderText="Part Name">
                                    <ItemTemplate>
                                        <asp:TextBox ID="lblPart_Name" runat="server"  Text='<%# Bind("Part_Name") %>' CssClass="form-control"
                                ...
                                <asp:TemplateField HeaderText="From">
                                    <ItemTemplate>
                                        <asp:TextBox ID="lblFrom" runat="server"  Text='<%# Bind("From") %>' CssClass="form-control"
                                            ToolTip='<%# Bind("From") %>' ReadOnly="true" BorderStyle="None" BackColor="Transparent" BorderWidth="0px"></asp:TextBox>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="To">
                                    <ItemTemplate>
                                        <asp:TextBox ID="lblTo" runat="server"  Text='<%# Bind("To") %>' CssClass="form-control"
                                            ToolTip='<%# Bind("To") %>' ReadOnly="true" BorderStyle="None" BackColor="Transparent" BorderWidth="0px"></asp:TextBox>
                                    </ItemTemplate>
                                    <ControlStyle Width="100px" />
                                    <HeaderStyle  width="100px" />
                                     <ItemStyle  Width="150px"/>
                                ...
                                <asp:TemplateField HeaderText="Plan">
                                    <ItemTemplate>
                                        <asp:TextBox ID="lblPlan" runat="server"  Text='<%# Bind("Plan") %>' CssClass="form-control"
                                            ToolTip='<%# Bind("Plan") %>' ReadOnly="true" BorderStyle="None" BackColor="Transparent" BorderWidth="0px"></asp:TextBox>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Act">
                                    <ItemTemplate>
                                        <asp:TextBox ID="lblAct" runat="server"  Text='<%# Bind("Act") %>' CssClass="form-control"
                                            ToolTip='<%# Bind("Act") %>' ReadOnly="true" BorderStyle="None" BackColor="Transparent" BorderWidth="0px"></asp:TextBox>
                                    </ItemTemplate>
                                    <ControlStyle Width="60px" />
                                    <HeaderStyle  width="100px" />
                                     <ItemStyle  Width="110px"/>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Bal">
                                    <ItemTemplate>
                                        <asp:TextBox ID="lblBal" runat="server"  Text='<%# Bind("Bal") %>' CssClass="form-control"
                                            ToolTip='<%# Bind("Bal") %>' ReadOnly="true" BorderStyle="None" BackColor="Transparent" BorderWidth="0px"></asp:TextBox>
                                    </ItemTemplate>
                                    <ControlStyle Width="60px" />
                                    <HeaderStyle  width="100px" />
                                     <ItemStyle  Width="110px"/>
