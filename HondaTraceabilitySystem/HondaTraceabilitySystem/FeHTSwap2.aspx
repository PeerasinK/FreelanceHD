<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeHTSwap2.aspx.cs" Inherits="HondaTraceabilitySystem.FeHTSwap2" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>FE Offline Swap - Honda Traceability System</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="230px">FE - Offline Swap</asp:Label>
        </div>
        <div>
