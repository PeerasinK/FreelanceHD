<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FGOnRpt.aspx.cs" Inherits="HondaTraceabilitySystem.FGOnRpt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>FG Online Summary Report - Honda Traceability System</title>
            ...
            <tr>
                <td style="width: 200px; height: 45px;" valign="top" colspan="2">
                    <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="330px">FG Online Summary Report</asp:Label>
                </td>
            </tr>
            </table>
        </div>
