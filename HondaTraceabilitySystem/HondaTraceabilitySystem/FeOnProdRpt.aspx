<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeOnProdRpt.aspx.cs" Inherits="HondaTraceabilitySystem.FeOnProdRpt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Online Summary Report - Honda Traceability System</title>
            ...
            <tr>
                <td style="width: 200px; height: 45px;" valign="top" colspan="2">
                    <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="330px">Online Summary Report</asp:Label>
                </td>
            </tr>
            </table>
        </div>
            ...
            <asp:panel id="pnlDetail" 
                ...
                <asp:GridView ID="gdvDetail" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="PC Lot No">                                
                            <ItemTemplate>
