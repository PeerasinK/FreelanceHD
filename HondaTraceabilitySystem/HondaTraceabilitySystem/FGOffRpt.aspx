<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FGOffRpt.aspx.cs" Inherits="HondaTraceabilitySystem.FGOffRpt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>FG Offline Summary Report - Honda Traceability System</title>
            ...
            <tr>
                <td style="width: 200px; height: 45px;" valign="top" colspan="2">
                    <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="330px">FG Offline Summary Report</asp:Label>
                </td>
            </tr>
            </table>
        </div>
            ...
            <asp:panel id="pnlDetail" 
                ...
                <asp:GridView ID="gdvDetail" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="KD Lot No">                                
                            <ItemTemplate>
                                <asp:TextBox ID="lblLOT_NO" runat="server" CssClass="form-control" 
                                    Text='<%# Bind("KD_Lot_No") %>' ToolTip='<%# Bind("KD_Lot_No") %>' 
                                    ReadOnly="True" TabIndex="-1"></asp:TextBox>
                            </ItemTemplate>
