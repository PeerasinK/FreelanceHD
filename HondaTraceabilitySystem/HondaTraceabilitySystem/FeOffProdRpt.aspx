<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeOffProdRpt.aspx.cs" Inherits="HondaTraceabilitySystem.FeOffProdRpt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Offline Summary Report - Honda Traceability System</title>
            ...
            <tr>
                <td style="width: 200px; height: 45px;" valign="top" colspan="2">
                    <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="330px">Offline Summary Report</asp:Label>
                </td>
            </tr>
            </table>
        </div>
            ...
            <asp:panel id="pnlDetail" 
                ...
                <asp:GridView ID="gdvDetail" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Offline No">                                
                            <ItemTemplate>
                                <asp:TextBox ID="lblOFFLINE_NO" runat="server" CssClass="form-control" 
                                    Text='<%# Bind("Offline_No") %>' ToolTip='<%# Bind("Offline_No") %>' 
                        ...
                        <asp:TemplateField HeaderText="Serial Code">                                
                            <ItemTemplate>
                                <asp:TextBox ID="lblSERIAL_CODE" runat="server" CssClass="form-control" 
                                    Text='<%# Bind("Online_Lotno") %>' ToolTip='<%# Bind("Online_Lotno") %>' 
                                    ReadOnly="True" TabIndex="-1"></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle width="180px"/>
                            <HeaderStyle width="180px"/>
