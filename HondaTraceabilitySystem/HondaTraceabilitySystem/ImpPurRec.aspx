...
<body>
    <form id="form1" runat="server">
            ...
            <tr>
                <td style="width: 200px; height: 45px;" valign="top" colspan="2">
                    <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="330px">Import Receiving</asp:Label>
                </td>
            </tr>
            </table>
        </div>
        ...
        <div style="WIDTH: 1073px; POSITION: relative; HEIGHT: 470px; left: 30px; top: 0px;">
            <asp:panel id="pnlKey" 
                    style="Z-INDEX: 103; LEFT: 45px; POSITION: absolute; TOP: 5px; width: 725px; height: 60px;" 
                    runat="server">
				
				<asp:RadioButtonList ID="rdoTYPE" runat="server" RepeatDirection="Vertical" 
                        style=" LEFT: 8px; POSITION: absolute; TOP: 10px; right: 642px;" AutoPostBack="True" OnSelectedIndexChanged="rdoTYPE_SelectedIndexChanged">
            ...
            <asp:panel id="pnlDetail" 
                    style="Z-INDEX: 102; LEFT: 7px; POSITION: absolute; TOP: 120px; height: 300px; width: 1200px;" 
                    runat="server">

                <asp:GridView ID="gdvDetail" runat="server" BorderColor="#999999" 
                    BorderWidth="1px" AllowPaging="True" PageSize="50" OnPageIndexChanging="gdvDetail_PageIndexChanging" 
                   >
                </asp:GridView>
