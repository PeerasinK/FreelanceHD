<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdPlanProdOrd.aspx.cs" Inherits="HondaTraceabilitySystem.UpdPlanProdOrd" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Update Production Order - Honda Traceability System</title>
    ...
    <form id="form1" runat="server" enctype="multipart/form-data">
            ...
            <tr>
                <td style="width: 200px; height: 45px;" valign="top" colspan="2">
                    <asp:Label ID="flblTitle" runat="server" Style="height: 23px;" CssClass="TitleLabel"
                            Width="330px">Update Production Order</asp:Label>
                </td>
            </tr>
            </table>
        </div>
        ...
        <div style="WIDTH: 1073px; POSITION: relative; HEIGHT: 470px; left: 0px; top: 0px;" >
            <asp:panel id="pnlKey" 
                ...
                <asp:DropDownList ID="ddlTYPE" runat="server" CssClass="form-control" Height="40px" Width="300px" 
                        style=" LEFT: 100px; POSITION: absolute; TOP: 10px" AutoPostBack="True" OnSelectedIndexChanged="ddlTYPE_SelectedIndexChanged" >
                    </asp:DropDownList>
                           
                <asp:Label ID="flblYear" runat="server" 
                        style=" LEFT: 8px; POSITION: absolute; TOP: 65px" 
                        Width="80px">Year:</asp:Label>

                <asp:DropDownList ID="ddlYear" runat="server" CssClass="form-control" Height="40px" 
                        style=" LEFT: 100px; POSITION: absolute; TOP: 60px; width: 113px;" AutoPostBack="False"  >
                    </asp:DropDownList>
                <asp:Label ID="flblMonth" runat="server" 
                        style=" LEFT: 220px; POSITION: absolute; TOP: 65px; width: 70px;">Month:</asp:Label>
                <asp:DropDownList ID="ddlMonth" runat="server" CssClass="form-control" Height="40px" 
                        style=" LEFT:270px; POSITION: absolute; TOP: 60px; width: 110px; " AutoPostBack="False"  >
                    </asp:DropDownList>

                <asp:Label ID="flblOrderNo" runat="server" 
                        style=" LEFT: 8px; POSITION: absolute; TOP: 115px" 
                        Width="80px" Visible="False">Order No:</asp:Label>
                <asp:DropDownList ID="ddlOrderNo" runat="server" CssClass="form-control" Height="40px" Width="300px" 
                        style=" LEFT: 100px; POSITION: absolute; TOP: 110px" AutoPostBack="True"  Visible="False" >
                    </asp:DropDownList>
                
                <asp:Label ID="flblUPLOAD" runat="server" 
                        style=" LEFT: 8px; POSITION: absolute; TOP: 165px" 
                        Width="80px">Excel File:</asp:Label>
                <asp:FileUpload ID="FileUpload1" runat="server" 
                        style="position: absolute; top: 160px; left: 100px; height: 40px; width: 300px;"/>
            ...
            <asp:panel id="pnlDetail" 
                    style="Z-INDEX: 102; LEFT: 7px; POSITION: absolute; TOP: 220px; height: 300px; width: 1000px;" 
                    runat="server">

                <asp:GridView ID="gdvDetail" runat="server"
                    AutoGenerateColumns="False" BorderColor="#999999" 
                    BorderWidth="1px" AllowPaging="True" PageSize="50" 
