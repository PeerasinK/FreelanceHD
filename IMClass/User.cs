...
namespace IMClass
{
    public class User
    {
        ...
        public int Insert()
        {
            ...
            strSQL.Append("INSERT INTO USER_MASTER ");
            strSQL.Append("(");
            strSQL.Append("USER_ID, FIRSTNAME, LASTNAME,");
            strSQL.Append("PASSWORD,");
            strSQL.Append("USER_GROUP, DEPT_NO, MANAGEMENT_LEVEL,");
            strSQL.Append("DESCRIPTION, POSITION,");
            strSQL.Append("ENTRY_DATE, UPDATE_DATE, USER_CREATE");
            strSQL.Append(") VALUES (");
            strSQL.Append("@USER_ID, @USER_FIRST_NAME, @USER_FAMILY_NAME,");
            strSQL.Append("@PASSWORD,");
            strSQL.Append("@MENU_GRP, @DEPT_CD, @MGMT_NO,");
            strSQL.Append("@NAME, @POSITION,");
            ...
            db.DbPsetInt("@DEPT_CD", int.Parse(_dept_cd));
            db.DbPsetInt("@MGMT_NO", int.Parse(_mgmt_no));
            db.DbPsetString("@NAME", _name);
            db.DbPsetString("@POSITION", _position);
        ...
        public int Update()
        {
            ...
            strSQL.Append("FIRSTNAME = @USER_FIRST_NAME,");
            strSQL.Append("LASTNAME = @USER_FAMILY_NAME,");
            ...
            strSQL.Append("USER_GROUP = @MENU_GRP,");
            strSQL.Append("DEPT_NO = @DEPT_CD,");
            strSQL.Append("MANAGEMENT_LEVEL = @MGMT_NO,");
            //strSQL.Append("LOGICAL_DEL_FLAG = @LOGICAL_DEL_FLAG,");
            strSQL.Append("DESCRIPTION = @NAME,");
        ...
        public int GetDetail()
        {
            ...
            //strSQL.Append("ENTRY_DATE, CHG_DATE, CHG_USER_ID, UPDATE_CNTR, ");
            strSQL.Append("SELECT USER_ID, PASSWORD, FIRSTNAME, LASTNAME,");
            strSQL.Append("DESCRIPTION, USER_GROUP, DEPT_NO, MANAGEMENT_LEVEL, POSITION,");
            strSQL.Append("ENTRY_DATE, UPDATE_DATE, USER_CREATE, USER_UPDATE, UPDATE_CNTR, ");

            //--- sql
            //strSQL.Append(" USER_FAMILY_NAME + ' ' + USER_FIRST_NAME AS NAME");
            strSQL.Append(" FIRSTNAME + ' ' + LASTNAME AS NAME");
            strSQL.Append(" FROM USER_MASTER ");
            ...
            else
            {
                ...
                //_name = db.Row("NAME");
                _user_id = db.Row("USER_ID");
                _user_first_name = db.Row("FIRSTNAME");
                _user_family_name = db.Row("LASTNAME");
                _name = db.Row("DESCRIPTION");
                _menu_grp = db.Row("USER_GROUP");
                _dept_cd = db.Row("DEPT_NO");
                _mgmt_no = db.Row("MANAGEMENT_LEVEL");
                _position = db.Row("POSITION");
                _entry_date = DateTime.Parse(db.Row("ENTRY_DATE"));
