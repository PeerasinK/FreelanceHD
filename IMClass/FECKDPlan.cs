...
namespace IMClass
{
    public class FECKDImport
    {
        ...
        public FECKDImport(string p_user_id, int p_lang)
        {
        ...
        protected string _fe_ckd_no = "";
        protected int _fe_ckd_line = 0;
        protected DateTime _fe_del_n_2;
        ...
        public string fe_ckd_no { get { return _fe_ckd_no; } set { _fe_ckd_no = value; } }
        public int fe_ckd_line { get { return _fe_ckd_line; } set { _fe_ckd_line = value; } }
        public DateTime fe_del_n_2 { get { return _fe_del_n_2; } set { _fe_del_n_2 = value; } }
        ...
        public int HeadUpdate()
        {
            ...
            db.DbBeginTrans();
            rtn = db.DbStored("SP_PLAN_PROD_FECKD_HEADER_UPDATE");
            rtn = db.DbPgetInt("RET");
            if (rtn == ComConst.SUCCEED)
            {
                db.DbCommit();
        ...
        public int DetailUpdate()
        {
            ...
            db.DbBeginTrans();
            rtn = db.DbStored("SP_PLAN_PROD_FECKD_DETAIL_UPDATE");
            rtn = db.DbPgetInt("RET");
            if (rtn == ComConst.SUCCEED)
            {
                db.DbCommit();
        ...
        public DataSet GetOrder()
        {
            ...
            strSQL.Append(" FE_CKD_NO AS HEAD_NO            ");
            strSQL.Append(" FROM PLAN_PROD_FE_CKD_HEADER   ");
