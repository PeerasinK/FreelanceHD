...
namespace IMClass
{
    public class WIPJo
    {
        ...
        public int Mfg_JoUpd2()
        {
            ...
            db.DbPsetInt("RET", rtn, ComConst.DB_RTN);
            db.DbPsetString("@I_SERIAL_CODE", _demand_no, ComConst.DB_IN);
            db.DbPsetString("@I_RACK_NO", _order_umsr, ComConst.DB_IN);
            db.DbPsetString("@I_SHIFT", _ws_cd, ComConst.DB_IN);
            db.DbPsetDate("@I_ACT_DATE", _entry_date, ComConst.DB_IN);    // HTS
            //db.DbPsetString("@I_CHG_PGM", _chg_pgm, ComConst.DB_IN);
            db.DbPsetString("@I_CHG_USER_ID", _chg_user_id, ComConst.DB_IN);
            db.DbPsetInt("@I_LANG", _lang, ComConst.DB_IN);
            //db.DbPsetInt("@I_UPDATE_CNTR", _update_cntr, ComConst.DB_IN);
        ...
        public int Mfg_JoUpd3()
        {
            ...
            db.DbPsetInt("RET", rtn, ComConst.DB_RTN);
            db.DbPsetString("@I_SERIAL_NO", _demand_no, ComConst.DB_IN);
            db.DbPsetDate("@I_ACT_DATE", _entry_date, ComConst.DB_IN);    // HTS
            //db.DbPsetString("@I_CHG_PGM", _chg_pgm, ComConst.DB_IN);
            db.DbPsetString("@I_CHG_USER_ID", _chg_user_id, ComConst.DB_IN);
            db.DbPsetInt("@I_LANG", _lang, ComConst.DB_IN);
        ...
        public int Mfg_JoUpd4A()
        {
            ...
            db.DbBeginTrans();
            rtn = db.DbStored("SP_MFG_JOUPD4A");
            rtn = db.DbPgetInt("RET");
            if (rtn == ComConst.SUCCEED)
            {
                db.DbCommit();
        ...
        public int Mfg_JoUpd5()
        {
            ...
            db.DbPsetInt("RET", rtn, ComConst.DB_RTN);
            db.DbPsetString("@I_SERIAL_NO", _demand_no, ComConst.DB_IN);
            db.DbPsetString("@I_MACHINE_NO", _resource_cd, ComConst.DB_IN);
            db.DbPsetString("@I_NG_CODE", _whs_cd, ComConst.DB_IN);
            db.DbPsetString("@I_SHIFT", _ws_cd, ComConst.DB_IN);
            db.DbPsetDate("@I_ACT_DATE", _entry_date, ComConst.DB_IN);    // HTS
            //db.DbPsetString("@I_CHG_PGM", _chg_pgm, ComConst.DB_IN);
            db.DbPsetString("@I_CHG_USER_ID", _chg_user_id, ComConst.DB_IN);
        ...
        public int Mfg_JoUpd5A()
        {
            ...
            db.DbBeginTrans();
            rtn = db.DbStored("SP_MFG_JOUPD5A");
            rtn = db.DbPgetInt("RET");
            if (rtn == ComConst.SUCCEED)
            {
                db.DbCommit();
        ...
        public DataSet Get_JOList2()
        {
            ...
            if (_process_cd == "Crank Shaft")
            {
                strSQL.Append(" T.FE_CRANK_ONLINE_NO ONLINE_NO,T.PART_NO,T.LOTNO_ZOZAI,T.REMARK, ");
            }
            else
            {
                strSQL.Append(" T.FE_CONN_ONLINE_NO ONLINE_NO,T.PART_NO,T.LOTNO_ZOZAI,T.REMARK, ");
            }
            strSQL.Append(" T.ONLINE_DATE,T.RECEIVE_QTY,T.DIE_NO,T.MODEL,D.SHIFT,D.ONLINE_STAMPING ");

            db.DbParametersClear();

            if (_process_cd == "Crank Shaft")
            {
                strSQL.Append(" FROM PROD_CRANK_ONLINE_HEADER T                                 ");
                strSQL.Append(" INNER JOIN PROD_CRANK_ONLINE_DETAIL D ON T.FE_CRANK_ONLINE_NO = D.FE_CRANK_ONLINE_NO    ");
                strSQL.Append(" LEFT JOIN PLC_CRANK_LESER_MARK P ON T.LOTNO_ZOZAI = SUBSTRING(P.SERIALCODE, 22, 8) ");
                strSQL.Append(" WHERE P.SERIALCODE IS NULL                                      ");
            }
            else
            {
                strSQL.Append(" FROM PROD_CONN_ONLINE_HEADER T                                  ");
                strSQL.Append(" INNER JOIN PROD_CONN_ONLINE_DETAIL D ON T.FE_CONN_ONLINE_NO = D.FE_CONN_ONLINE_NO    ");
                strSQL.Append(" LEFT JOIN PLC_CRANK_LESER_MARK P ON T.LOTNO_ZOZAI = SUBSTRING(P.SERIALCODE, 22, 8) ");
                strSQL.Append(" WHERE P.SERIALCODE IS NULL                                      ");
            }
        ...
        public DataSet Get_JOList3()
        {
            ...
            strSQL.Append(" SELECT                                                              ");
            strSQL.Append(" T.FE_CRANK_ONLINE_NO ONLINE_NO,T.PART_NO,T.LOTNO_ZOZAI,T.REMARK,    ");
            strSQL.Append(" T.ONLINE_DATE,'' RACK_NO,P.SERIALCODE,T.MODEL,D.SHIFT                 ");
        ...
        public DataSet Get_JOList4()
        {
            ...
            if (_process_cd == "Crank Shaft")
            {
                strSQL.Append(" T.FE_CRANK_MIDDLE_NO ONLINE_NO,T.PART_NO,T.PROD_LOTNO LOTNO,T.MIDDLE_ONLINE_DATE ONLINE_DATE,T.RACK_NO, ");
                strSQL.Append(" D.QTY,P.SERIALCODE,T.MODEL,D.SHIFT                            ");
            }
            else
            {
                strSQL.Append(" T.FE_CONN_ONLINE_NO ONLINE_NO,T.PART_NO,T.LOTNO_ZOZAI LOTNO,T.ONLINE_DATE,'' RACK_NO, ");
                strSQL.Append(" T.RECEIVE_QTY QTY,P.SERIALCODE,T.MODEL,D.SHIFT                            ");
            }
            ...
            if (_process_cd == "Crank Shaft")
            {
                strSQL.Append(" FROM PROD_CRANK_MIDDLE_HEADER T                                 ");
                strSQL.Append(" INNER JOIN PROD_CRANK_MIDDLE_DETAIL D ON T.FE_CRANK_MIDDLE_NO = D.FE_CRANK_MIDDLE_NO ");
                strSQL.Append(" LEFT JOIN PLC_CRANK_BEARING_CODE P ON D.LOTNO = P.SERIALCODE    ");
            }
            else
            {
                strSQL.Append(" FROM PROD_CONN_ONLINE_HEADER T                                  ");
                strSQL.Append(" INNER JOIN PROD_CONN_ONLINE_DETAIL D ON T.FE_CONN_ONLINE_NO = D.FE_CONN_ONLINE_NO    ");
                strSQL.Append(" LEFT JOIN PLC_CONN_DIE_WEIGHT P ON T.LOTNO_ZOZAI = SUBSTRING(P.SERIALCODE, 22, 8)    ");
            }
        ...
        public DataSet Get_JOList5()
        {
            ...
            if (_process_cd == "Crank Shaft")
            {
                strSQL.Append(" T.FE_CRANK_OFFLINE OFFLINE_NO,T.PART_NO,T.PROD_LOTNO LOTNO,D.REMARK, ");
                strSQL.Append(" T.PRODUCT_DATE,D.QTY,T.RACK_NO,T.MODEL,D.SHIFT,D.ONLINE_LOTNO, ");
                strSQL.Append(" P.RESULT_5J RESULT1, P.RESULT_4J RESULT2, P.RESULT_3J RESULT3, ");
                strSQL.Append(" P.RESULT_2J RESULT4, P.RESULT_1J RESULT5, ");
                strSQL.Append(" P.RESULT_4P, P.RESULT_3P, P.RESULT_2P, P.RESULT_1P ");
            }
            else
            {
                strSQL.Append(" T.FE_CONN_OFFLINE OFFLINE_NO,T.PART_NO,D.OFFLINE_LOTNO LOTNO,'' REMARK, ");
                strSQL.Append(" T.PRODUCT_DATE,D.QTY,T.RACK_NO,T.MODEL,D.SHIFT,'' ONLINE_LOTNO, ");
                strSQL.Append(" P.RESULT_WEIGHT RESULT1, P.RESULT_RANK RESULT2, P.RESULT_SMALLDIA RESULT3, ");
                strSQL.Append(" P.RESULT_LAGEDIA RESULT4, P.RESULT_DIA1 RESULT5, ");
                strSQL.Append(" '' RESULT_4P, '' P.RESULT_3P, '' P.RESULT_2P, '' P.RESULT_1P ");
            }
            ...
            if (_process_cd == "Crank Shaft")
            {
                strSQL.Append(" FROM PROD_CRANK_OFFLINE_HEADER T                                ");
                strSQL.Append(" INNER JOIN PROD_CRANK_OFFLINE_DETAIL D ON T.FE_CRANK_OFFLINE = D.FE_CRANK_OFFLINE ");
                strSQL.Append(" LEFT JOIN PLC_CRANK_BEARING_CODE P ON D.ONLINE_LOTNO = P.SERIALCODE ");
            }
            else
            {
                strSQL.Append(" FROM PROD_CONN_OFFLINE_HEADER T                                 ");
                strSQL.Append(" INNER JOIN PROD_CONN_OFFLINE_DETAIL D ON T.FE_CONN_OFFLINE = D.FE_CONN_OFFLINE ");
                strSQL.Append(" LEFT JOIN PLC_CONN_DIE_WEIGHT P ON SUBSTRING(D.OFFLINE_LOTNO, 8, 4) = SUBSTRING(P.SERIALCODE, 7, 4) ");
            }
