...
namespace IMClass
{
    ...
    public class Jo
    {
        ...
        public int Inv_ManWhsInsert()
        {
            ...
            db.DbPsetString("@I_KD_LOT_NO", _plan_no, ComConst.DB_IN);
            db.DbPsetString("@I_PRODUCT_TYPE", _catg_cd, ComConst.DB_IN);
            db.DbPsetString("@I_FG_LOT_NO", _demand_no, ComConst.DB_IN);
            //db.DbPsetString("@I_CHG_PGM", _chg_pgm, ComConst.DB_IN);
            db.DbPsetString("@I_CHG_USER_ID", _chg_user_id, ComConst.DB_IN);
            db.DbPsetInt("@I_LANG", _lang, ComConst.DB_IN);
            db.DbPsetInt("@O_ERRCODE", _errcode, ComConst.DB_OUT);
        ...
        public int Inv_ManWhsInsertA()
        {
            ...
            db.DbBeginTrans();
            rtn = db.DbStored("SP_INV_MANWHS_INSERTA");
            rtn = db.DbPgetInt("RET");
            if (rtn == ComConst.SUCCEED)
            {
                db.DbCommit();
        ...
        public int Inv_ManWhsInsertB()
        {
            ...
            db.DbBeginTrans();
            rtn = db.DbStored("SP_INV_MANWHS_INSERTB");
            rtn = db.DbPgetInt("RET");
            if (rtn == ComConst.SUCCEED)
            {
                db.DbCommit();
        ...
        public int Inv_ManWhsInsertC()
        {
            ...
            db.DbBeginTrans();
            rtn = db.DbStored("SP_INV_MANWHS_INSERTC");
            rtn = db.DbPgetInt("RET");
            if (rtn == ComConst.SUCCEED)
            {
                db.DbCommit();
